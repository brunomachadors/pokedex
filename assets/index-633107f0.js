 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(O,T){var A=O.length;O.push(T);e:for(;0<A;){var B=A-1>>>1,ne=O[B];if(0<i(ne,T))O[B]=T,O[A]=ne,A=B;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var T=O[0],A=O.pop();if(A!==T){O[0]=A;e:for(var B=0,ne=O.length,At=ne>>>1;B<At;){var Be=2*(B+1)-1,vt=O[Be],Ue=Be+1,st=O[Ue];if(0>i(vt,A))Ue<ne&&0>i(st,vt)?(O[B]=st,O[Ue]=A,B=Ue):(O[B]=vt,O[Be]=A,B=Be);else if(Ue<ne&&0>i(st,A))O[B]=st,O[Ue]=A,B=Ue;else break e}}return T}function i(O,T){var A=O.sortIndex-T.sortIndex;return A!==0?A:O.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var s=[],u=[],d=1,c=null,p=3,w=!1,g=!1,v=!1,P=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(O){for(var T=n(u);T!==null;){if(T.callback===null)r(u);else if(T.startTime<=O)r(u),T.sortIndex=T.expirationTime,t(s,T);else break;T=n(u)}}function x(O){if(v=!1,m(O),!g)if(n(s)!==null)g=!0,Or(E);else{var T=n(u);T!==null&&hn(x,T.startTime-O)}}function E(O,T){g=!1,v&&(v=!1,h(R),R=-1),w=!0;var A=p;try{for(m(T),c=n(s);c!==null&&(!(c.expirationTime>T)||O&&!le());){var B=c.callback;if(typeof B=="function"){c.callback=null,p=c.priorityLevel;var ne=B(c.expirationTime<=T);T=e.unstable_now(),typeof ne=="function"?c.callback=ne:c===n(s)&&r(s),m(T)}else r(s);c=n(s)}if(c!==null)var At=!0;else{var Be=n(u);Be!==null&&hn(x,Be.startTime-T),At=!1}return At}finally{c=null,p=A,w=!1}}var b=!1,k=null,R=-1,M=5,L=-1;function le(){return!(e.unstable_now()-L<M)}function fn(){if(k!==null){var O=e.unstable_now();L=O;var T=!0;try{T=k(!0,O)}finally{T?pn():(b=!1,k=null)}}else b=!1}var pn;if(typeof f=="function")pn=function(){f(fn)};else if(typeof MessageChannel<"u"){var zi=new MessageChannel,il=zi.port2;zi.port1.onmessage=fn,pn=function(){il.postMessage(null)}}else pn=function(){P(fn,0)};function Or(O){k=O,b||(b=!0,pn())}function hn(O,T){R=P(function(){O(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,Or(E))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(O){switch(p){case 1:case 2:case 3:var T=3;break;default:T=p}var A=p;p=T;try{return O()}finally{p=A}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,T){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var A=p;p=O;try{return T()}finally{p=A}},e.unstable_scheduleCallback=function(O,T,A){var B=e.unstable_now();switch(typeof A=="object"&&A!==null?(A=A.delay,A=typeof A=="number"&&0<A?B+A:B):A=B,O){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=A+ne,O={id:d++,callback:T,priorityLevel:O,startTime:A,expirationTime:ne,sortIndex:-1},A>B?(O.sortIndex=A,t(u,O),n(s)===null&&O===n(u)&&(v?(h(R),R=-1):v=!0,hn(x,A-B))):(O.sortIndex=ne,t(s,O),g||w||(g=!0,Or(E))),O},e.unstable_shouldYield=le,e.unstable_wrapCallback=function(O){var T=p;return function(){var A=p;p=T;try{return O.apply(this,arguments)}finally{p=A}}}})(Vf);Wf.exports=Vf;var X0=Wf.exports;/**
 * @license React
...
`,Ok={selectedMainMenu:""},k0=Lt({name:"mainMenu",initialState:Ok,reducers:{selectMainMenu:(e,t)=>{e.selectedMainMenu=t.payload}}}),{selectMainMenu:_k}=k0.actions,Rk=k0.reducer;function nl({onButtonClick:e}){const[t,n]=F.useState(5),r=["POKÉMON","TYPES","ITEMS","REGIONS","FOSSILS"],i=cn(),o=I(s=>s.mainMenu.selectedMainMenu);F.useEffect(()=>{a(t,o)});const a=(s,u)=>{i(_k(u)),n(s),e&&e(s)},l=s=>`icons/${s.toLowerCase()}.png`;return y.jsx(Ck,{id:"buttonContainer","aria-label":"Button Container",children:r.map((s,u)=>y.jsxs(Pk,{id:s,selected:t===u,onClick:()=>a(u,s),"aria-label":`${s} Button`,children:[y.jsx(bk,{src:l(s),"aria-label":`${s} Icon`}),y.jsx(jk,{"aria-label":`${s} Text`,children:s})]},u))})}const Fk=j.div`
  display: flex;
  width: 100%;
  height: 18%;
  justify-content: flex-start;
...
`,Mk=j.div`
  ...
  border-radius: 50%;
  border: solid black 1px;
`;function Dk(){return y.jsxs(Fk,{"aria-label":"Pokedex Header Container",children:[y.jsxs(Ik,{"aria-label":"Balls Container",children:[y.jsx(Ak,{"aria-label":"Pokedex Header Ball"}),y.jsxs(Nk,{"aria-label":"Lights Container",children:[y.jsx($k,{"aria-label":"Red Light"}),y.jsx(zk,{"aria-label":"Yellow Light"}),y.jsx(Mk,{"aria-label":"Green Light"})]})]}),y.jsx(Lk,{"aria-label":"Pokedex Header Lines"})]})}const Bk=j.div`
  display: flex;
  height: 40%;
  width: 80%;
  align-items: center;
...
`;var su=(e=>(e[e.First=1]="First",e[e.Second=152]="Second",e[e.Third=252]="Third",e[e.Fourth=387]="Fourth",e[e.Fifth=494]="Fifth",e[e.Sixth=650]="Sixth",e[e.Seventh=722]="Seventh",e[e.Eighth=810]="Eighth",e[e.Ninth=906]="Ninth",e))(su||{});function Lf(e){let t,n;switch(e){case 1:t=1,n=151;break;case 152:t=152,n=251;break;case 252:t=252,n=386;break;case 387:t=387,n=493;break;case 494:t=494,n=649;break;case 650:t=650,n=721;break;case 722:t=722,n=809;break;case 810:t=810,n=905;break;case 906:t=906,n=1302;break;default:throw new Error("Invalid Pokémon Generation")}return{start:t,end:n}}const Hk=async(e=1,t=151)=>{const n={method:"get",maxBodyLength:1/0,url:`${Fi}${Li.pokemon.pokemon}?offset=${e-1}&limit=${t}`,headers:{}};try{return(await Tt.request(n)).data}catch(r){console.error(r)}},Wk=async e=>{const t={method:"get",maxBodyLength:1/0,url:`${Fi}${Li.pokemon.pokemon}/${e}`,headers:{}};try{return(await Tt.request(t)).data}catch(n){console.error(n)}},Vk={selectedPokemon:{name:"",url:"",id:0,image:"",types:[]}},E0=Lt({name:"pokemon",initialState:Vk,reducers:{selectPokemon:(e,t)=>{e.selectedPokemon=t.payload}}}),{selectPokemon:Gk}=E0.actions,Qk=E0.reducer,Kk={selectedType:""},C0=Lt({name:"type",initialState:Kk,reducers:{selectType:(e,t)=>{e.selectedType=t.payload}}}),{selectType:Yk}=C0.actions,Xk=C0.reducer;function $i(){return y.jsx(qk,{})}const qk=j.img.attrs({src:"https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/029b8bd9-cb5a-41e4-9c7e-ee516face9bb/dayo3ow-7ac86c31-8b2b-4810-89f2-e6134caf1f2d.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..ooubhxjHp9PIMhVxvCFHziI6pxDAS8glXPWenUeomWs",alt:"Pikachu Loading"})`
  width: 20vw;
...
catches a POKéMON
without fail.`,version_group:{name:"ruby-sapphire",url:"https://pokeapi.co/api/v2/version-group/5/"}}],fling_effect:null,fling_power:null,game_indices:[{game_index:0,generation:{name:"",url:""}}],held_by_pokemon:[],id:0,machines:[],name:"",names:[{language:{name:"",url:""},name:""}],sprites:{default:""}}},P0=Lt({name:"item",initialState:Zk,reducers:{selectItem:(e,t)=>{e.selectedItem=t.payload}}}),{selectItem:j0}=P0.actions,e2=P0.reducer,t2=async()=>{const e={method:"get",maxBodyLength:1/0,url:`${Fi}${Li.locations.region}`,headers:{}};try{return(await Tt.request(e)).data.results}catch(t){console.error(t)}};async function n2(){const e={method:"get",maxBodyLength:1/0,url:"https://pokeapi.co/api/v2/item-category/35/",headers:{}};try{return(await Tt.request(e)).data.items}catch(t){console.error(t)}}function rl(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(Bk,{children:[e==="POKÉMON"&&y.jsx(r2,{}),e==="TYPES"&&y.jsx(i2,{}),e==="ITEMS"&&y.jsx(o2,{}),e==="REGIONS"&&y.jsx(a2,{}),e==="FOSSILS"&&y.jsx(l2,{})]})}function r2(){const[e,t]=F.useState(!0),n=I(s=>s.pokemonList.lists),r=cn(),i=Lf(su.First),o=Lf(su.Ninth);F.useEffect(()=>{async function s(){try{t(!0);const u=await Hk(i.start,o.end),d=await Promise.all(u.results.map(async c=>{const p=await Wk(c.name);return{...c,id:p.id,image:p.sprites.other["official-artwork"].front_default,types:p.types.map(g=>g.type.name)}}));r(hk(d)),r(ou(d))}catch(u){console.error("Error fetching Pokemon data:",u)}finally{t(!1)}}s()},[r,i.start,i.end]);const a=s=>{r(Gk(s))};function l(s){return"types/"+s.toLowerCase()+".svg"}return y.jsx(Ni,{children:e?y.jsx($i,{}):y.jsx(Ai,{"aria-label":"pokemon list",children:n.filteredList.map(s=>{var u,d;return y.jsx(Ti,{color:De.colors.type[(u=s.types)==null?void 0:u[0]],"aria-label":"Select the pokemon "+s.name,onClick:()=>a(s),children:y.jsxs(Ii,{"data-cy":s.name,children:[y.jsxs(Ke,{children:["#",s.id]}),y.jsx(Ke,{children:s.name.toUpperCase()}),y.jsx(Ke,{children:(d=s.types)==null?void 0:d.map(c=>y.jsx(ra,{src:l(c),alt:c},c))})]})},s.name)})})})}function i2(){const[e,t]=F.useState(!0),n=cn(),r=I(a=>a.typeList.lists.filteredList);F.useEffect(()=>{async function a(){t(!0);const l=await XS(),s=await Promise.all(l.map(async u=>({typeInfo:await h0(u.name)})));n(yk(s)),n(au(s)),t(!1)}a()},[n]);function i(a){return"types/"+a.toLowerCase()+".svg"}const o=a=>{n(Yk(a))};return y.jsx(Ni,{children:e?y.jsx($i,{}):y.jsx(Ai,{"aria-label":"Type list",children:r.map(a=>y.jsx(Ti,{color:De.colors.type[a.typeInfo.name],"aria-label":"Select the type "+a.typeInfo.name,onClick:()=>o(a.typeInfo.name),children:y.jsxs(Ii,{children:[y.jsxs(Ke,{children:["#",a.typeInfo.id]}),y.jsx(Ke,{children:a.typeInfo.name.toUpperCase()}),y.jsx(Ke,{children:y.jsx(ra,{src:i(a.typeInfo.name),alt:a.typeInfo.name})})]})},a.typeInfo.name))})})}function o2(){const[e,t]=F.useState(!0),n=cn(),r=I(o=>o.itemList.lists.filteredList);F.useEffect(()=>{async function o(){try{const a=await Jk(),l=await Promise.all(a.map(async s=>await _c(s.url)));n(x0(l)),n(oa(l)),t(!1)}catch(a){console.error("Error fetching items:",a),t(!1)}}o()},[n]);const i=o=>{n(j0(o))};return y.jsx(Ni,{children:e?y.jsx($i,{}):y.jsx(Ai,{"aria-label":"Item list",children:r.map(o=>{var a,l;return y.jsx(Ti,{color:De.colors.itemTypeColorMap[(a=o.category)==null?void 0:a.name],"aria-label":"Select the item "+o.name,onClick:()=>i(o),children:y.jsxs(Ii,{children:[y.jsxs(Ke,{children:["#",o.id]}),y.jsx(Ke,{children:o.name.toUpperCase()}),y.jsx(_m,{src:(l=o.sprites)==null?void 0:l.default})]})},o.id)})})})}function a2(){const[e,t]=F.useState(!0),n=I(o=>o.regions.lists.filteredList),r=cn();F.useEffect(()=>{async function o(){const a=await t2(),l=await Promise.all(a.map(async s=>await _c(s.url)));r(Sk(l)),r(lu(l)),t(!1)}o()},[r]);const i=o=>{r(kk(o))};return y.jsx(Ni,{children:e?y.jsx($i,{}):y.jsx(Ai,{"aria-label":"Region list",children:n.map(o=>y.jsx(Ti,{color:De.colors.regionColorMap[o.name],"aria-label":"Select the region "+o.name,onClick:()=>i(o),children:y.jsxs(Ii,{children:[y.jsxs(Ke,{children:["#",o.id]}),y.jsx(Ke,{children:o.name.toUpperCase()}),y.jsx(Uk,{src:"icons/map.png"})]})},o.name))})})}function l2(){const[e,t]=F.useState(!0),n=cn(),r=I(o=>o.itemList.lists.filteredList);F.useEffect(()=>{async function o(){try{const a=await n2(),l=await Promise.all(a.map(async s=>await _c(s.url)));n(x0(l)),n(oa(l)),t(!1)}catch(a){console.error("Error fetching items:",a),t(!1)}}o()},[n]);const i=o=>{n(j0(o))};return y.jsx(Ni,{children:e?y.jsx($i,{}):y.jsx(Ai,{"aria-label":"Fossil list",children:r.map(o=>{var a,l;return y.jsx(Ti,{color:De.colors.itemTypeColorMap[(a=o.category)==null?void 0:a.name],"aria-label":"Select the fossil"+o.name,onClick:()=>i(o),children:y.jsxs(Ii,{children:[y.jsxs(Ke,{children:["#",o.id]}),y.jsx(Ke,{children:o.name.toUpperCase()}),y.jsx(_m,{src:(l=o.sprites)==null?void 0:l.default})]})},o.id)})})})}const s2=j.audio`
  width: 250px;
  background-color: transparent;
  position: relative;
  bottom: 0;
...
`,u2=()=>{const e=F.useRef(null);return F.useEffect(()=>{e.current&&(e.current.volume=.5)},[]),y.jsx(s2,{controls:!0,ref:e,id:"music",children:y.jsx("source",{src:"opening.mp3",type:"audio/mp3"})})};function c2(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(e1,{"aria-label":"Pokedex Web Container",children:[y.jsxs(t1,{"aria-label":"Pokedex Left Side",children:[y.jsx(Dk,{"aria-label":"Header"}),y.jsxs(ba,{"aria-label":"Pokedex Left Content",children:[y.jsx(g0,{"aria-label":"Display"}),y.jsx(nl,{"aria-label":"Buttons Menu"}),e!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(u2,{"aria-label":"Music Player"})]})]}),y.jsx(n1,{"aria-label":"Pokedex Right Side",children:y.jsxs(r1,{"aria-label":"Pokedex Right Content",children:[y.jsx(el,{"aria-label":"Display Monitor"}),y.jsx(rl,{"aria-label":"Lists"})]})})]})}function d2(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(ba,{"aria-label":"Pokedex Mobile Content",children:[y.jsx(el,{"aria-label":"Display Monitor"}),y.jsx(nl,{"aria-label":"Buttons Menu"}),e!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(rl,{"aria-label":"Lists"})]})}const f2=({size:e})=>{const t=I(n=>n.mainMenu.selectedMainMenu);return y.jsxs(ba,{"aria-label":"Pokedex Landscape Content",children:[y.jsx(el,{"aria-label":"Display Monitor"}),y.jsxs(i1,{"aria-label":"Pokedex Landscape Container",children:[y.jsx(nl,{"aria-label":"Buttons Menu"}),e>=800&&t!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(rl,{"aria-label":"Lists"})]})]})};function p2(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(ba,{"aria-label":"Pokedex Tablet Content",children:[y.jsx(g0,{"aria-label":"Display"}),y.jsx(nl,{"aria-label":"Buttons Menu"}),y.jsx(el,{"aria-label":"Display Monitor"}),e!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(rl,{"aria-label":"Lists"})]})}globalThis&&globalThis.__awaiter;function h2(e,t,n,r){const i=F.useRef(t);b0(()=>{i.current=t},[t]),F.useEffect(()=>{var o;const a=(o=n==null?void 0:n.current)!==null&&o!==void 0?o:window;if(!(a&&a.addEventListener))return;const l=s=>i.current(s);return a.addEventListener(e,l,r),()=>{a.removeEventListener(e,l,r)}},[e,n,r])}globalThis&&globalThis.__awaiter;const b0=typeof window<"u"?F.useLayoutEffect:F.useEffect;function m2(){const[e,t]=F.useState({width:0,height:0}),n=()=>{t({width:window.innerWidth,height:window.innerHeight})};return h2("resize",n),b0(()=>{n()},[]),e}function g2(){const{width:e,height:t}=m2(),[n,r]=F.useState(null);return F.useEffect(()=>{t<e&&e<1367?r(y.jsx(f2,{size:t,"aria-label":"Pokedex in landscape mode"})):e<600?r(y.jsx(d2,{"aria-label":"Pokedex in mobile mode"})):e<1280?r(y.jsx(p2,{"aria-label":"Pokedex in tablet mode"})):r(y.jsx(c2,{"aria-label":"Pokedex in web mode"}))},[e,t]),y.jsx(y.Fragment,{children:n})}function y2(){return y.jsx(Jv,{theme:De,children:y.jsx(g2,{})})}const v2=yx({reducer:{pokemon:Qk,infoMenu:Ox,mainMenu:Rk,pokemonList:mk,typeList:vk,itemList:Ff,fossilList:Ff,type:Xk,item:e2,regions:Ek}});Kl.createRoot(document.getElementById("root")).render(y.jsx(Z1,{store:v2,children:y.jsx(y2,{})}));

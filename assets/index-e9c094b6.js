...
`,j0=({totalPages:e,currentPage:t,onPageChange:n})=>{const r=()=>{const i=[];for(let o=1;o<=e;o++)i.push(y.jsx(a2,{children:y.jsx(l2,{active:o===t,onClick:()=>n(o),children:o})},o));return i};return y.jsx(i2,{children:y.jsx(o2,{children:r()})})},s2=P.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: flex-start;
...
`,m2=()=>{const e=F.useRef(null);return F.useEffect(()=>{e.current&&(e.current.volume=.5)},[]),y.jsx(h2,{controls:!0,ref:e,id:"music",children:y.jsx("source",{src:"opening.mp3",type:"audio/mp3"})})};function g2(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(e1,{"aria-label":"Pokedex Web Container",children:[y.jsxs(t1,{"aria-label":"Pokedex Left Side",children:[y.jsx(Bk,{"aria-label":"Header"}),y.jsxs(ba,{"aria-label":"Pokedex Left Content",children:[y.jsx(m0,{"aria-label":"Display"}),y.jsx(nl,{"aria-label":"Buttons Menu"}),e!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(m2,{"aria-label":"Music Player"})]})]}),y.jsx(n1,{"aria-label":"Pokedex Right Side",children:y.jsxs(r1,{"aria-label":"Pokedex Right Content",children:[y.jsx(el,{"aria-label":"Display Monitor"}),y.jsx(rl,{"aria-label":"Lists"})]})})]})}function y2(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(ba,{"aria-label":"Pokedex Mobile Content",children:[y.jsx(el,{"aria-label":"Display Monitor"}),y.jsx(nl,{"aria-label":"Buttons Menu"}),e!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(rl,{"aria-label":"Lists"})]})}const v2=({size:e})=>{const t=I(n=>n.mainMenu.selectedMainMenu);return y.jsxs(ba,{"aria-label":"Pokedex Landscape Content",children:[y.jsx(el,{"aria-label":"Display Monitor"}),y.jsxs(i1,{"aria-label":"Pokedex Landscape Container",children:[y.jsx(nl,{"aria-label":"Buttons Menu"}),e>=800&&t!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(rl,{"aria-label":"Lists"})]})]})};function w2(){const e=I(t=>t.mainMenu.selectedMainMenu);return y.jsxs(ba,{"aria-label":"Pokedex Tablet Content",children:[y.jsx(m0,{"aria-label":"Display"}),y.jsx(nl,{"aria-label":"Buttons Menu"}),y.jsx(el,{"aria-label":"Display Monitor"}),e!==""&&y.jsx(tl,{"aria-label":"Search"}),y.jsx(rl,{"aria-label":"Lists"})]})}globalThis&&globalThis.__awaiter;function x2(e,t,n,r){const i=F.useRef(t);b0(()=>{i.current=t},[t]),F.useEffect(()=>{var o;const a=(o=n==null?void 0:n.current)!==null&&o!==void 0?o:window;if(!(a&&a.addEventListener))return;const l=s=>i.current(s);return a.addEventListener(e,l,r),()=>{a.removeEventListener(e,l,r)}},[e,n,r])}globalThis&&globalThis.__awaiter;const b0=typeof window<"u"?F.useLayoutEffect:F.useEffect;function S2(){const[e,t]=F.useState({width:0,height:0}),n=()=>{t({width:window.innerWidth,height:window.innerHeight})};return x2("resize",n),b0(()=>{n()},[]),e}function k2(){const{width:e,height:t}=S2(),[n,r]=F.useState(null);return F.useEffect(()=>{t<e&&e<1367?r(y.jsx(v2,{size:t,"aria-label":"Pokedex in landscape mode"})):e<600?r(y.jsx(y2,{"aria-label":"Pokedex in mobile mode"})):e<1280?r(y.jsx(w2,{"aria-label":"Pokedex in tablet mode"})):r(y.jsx(g2,{"aria-label":"Pokedex in web mode"}))},[e,t]),y.jsx(y.Fragment,{children:n})}function E2(){return y.jsx(Jv,{theme:De,children:y.jsx(k2,{})})}const C2={lists:{originalList:[],filteredList:[]}},P2=yt({name:"list",initialState:C2,reducers:{updateOriginalFossilList:(e,t)=>{e.lists.originalList=t.payload},updateFilteredFossilList:(e,t)=>{e.lists.filteredList=t.payload}}}),j2=P2.reducer,b2=yx({reducer:{pokemon:r2,infoMenu:Ox,mainMenu:Fk,pokemonList:mk,typeList:vk,itemList:xk,fossilList:j2,type:Gk,item:Xk,regions:Ck}});Kl.createRoot(document.getElementById("root")).render(y.jsx(Z1,{store:b2,children:y.jsx(E2,{})}));
